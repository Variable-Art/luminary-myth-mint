    ...
    >
      ...
      <CardFooter className="flex justify-between border-t border-white/10 pt-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" className="border-myth-primary/50 text-myth-light hover:bg-myth-primary/20">
            Mint
          </Button>
          <Button size="sm" className="bg-myth-primary hover:bg-myth-primary/90 text-white">
            Build Upon
          </Button>
        </div>
      </CardFooter>
